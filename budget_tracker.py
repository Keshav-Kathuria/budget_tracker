...
def load_budget_data(filepath):
    try:
        ...
        return 0 ,[]  # return default values if file doesn't exist or is empty/corrupted
...
def main():
    ...
    filepath = 'budget_data.json' #define the path for the json file
    ...
    while True:
        ...
        if choice == "1":
            ...
            show_budget_details(budget,expenses)
             ...
             print(f"Updated initial budget to: {new_budget}")
        elif choice == "4":
